                  ...
                  Positioned.fill(
                    child: Image.network(
                      ...
                      errorBuilder: (context, error, stackTrace) {
                        return const Center(
                          child:
                              Icon(Icons.movie, color: Colors.white, size: 300),
                        );
                      },
                    ),
                  ),
                      ...
                      children: [
                          ...
                          BlocBuilder<WatchListCubit, WatchListState>(
                            builder: (context, state) {
                              ...
                              if (state is WatchListLoaded) {
                                isSaved = state.movies.any((movie) => movie.data?.movie?.id == widget.movieId);
                              }
                                ...
                                onPressed: () {
                                  if (isSaved) {
                                    ...
                                    context.read<WatchListCubit>().addMovieToWatchlist(
                                      MovieDetailsResponse(data: Data(movie: Movie(id: widget.movieId))),
                                      "your_token_here",
                                    );
                                  }
                                },
                        ...
                        Container(
                          ...
                          child: Row(
                            children: [
                              CustomIconWithText(
                                  imagePath: AssetsManager.favouriteIcon,
                                  text: movie.likeCount!.toString()),
                              SizedBox(width: width * (16 / 430)),
                              CustomIconWithText(
                                  imagePath: AssetsManager.watchesIcon,
                                  text: movie.runtime!.toString()),
                              SizedBox(width: width * (16 / 430)),
                              CustomIconWithText(
                                  imagePath: AssetsManager.starIcon,
                        ...
                        Padding(
                          padding: EdgeInsets.only(
                              left: width * 0.03, right: width * 0.82),
                          child: Text(
                            'Cast',
                            style: AppStyles.bold22white,
                          ),
                        ...
                        Padding(
                          padding: EdgeInsets.only(
                              left: width * 0.03, right: width * 0.74),
                          child: Text(
                            'Genres',
                            style: AppStyles.bold22white,
                          ),
